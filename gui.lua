...
RETARDEDLABELS.BackgroundColor3 = Color3.fromRGB( 0, 255, 0)
...
RETARDEDLABELS_2.BackgroundColor3 = Color3.fromRGB( 0, 255, 0)
...
RETARDEDLABELS_2.TextColor3 = Color3.fromRGB( 0, 255, 0)
RETARDEDLABELS_2.TextSize = 28.000

VersionLabel.Name = "VersionLabel"
VersionLabel.Parent = Holder
VersionLabel.BackgroundColor3 = Color3.fromRGB( 0, 255, 0)
...
local OblivionAdmin = Instance.new("ScreenGui")
---syn.protect_gui(OblivionAdmin)
...
OblivionAdmin.Name = "Oblivion Admin"
OblivionAdmin.Parent = game.CoreGui
OblivionAdmin.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

Loader.Name = "Loader"
Loader.Parent = OblivionAdmin
Loader.AnchorPoint = Vector2.new(0.5, 0.5)
Loader.BackgroundColor3 = Color3.fromRGB( 1, 1, 1)
...
Close_3.Text = "_"
Close_3.TextColor3 = Color3.fromRGB( 0, 255, 0)
...
ON.BorderColor3 = Color3.fromRGB( 0, 255 , 0)
...
OFF.BackgroundColor3 = Color3.fromRGB( 1, 1, 1)
...
LoadingMessage.BackgroundColor3 = Color3.fromRGB( 1, 1, 1)
LoadingMessage.BorderSizePixel = 1
LoadingMessage.BorderColor3 = Color3.fromRGB( 0, 255, 0)
...
LoadingMessage.TextColor3 = Color3.fromRGB( 0, 255, 0)
...
Commands.Parent = OblivionAdmin
Commands.AnchorPoint = Vector2.new(0,1)
Commands.BackgroundColor3 = Color3.fromRGB( 1, 1, 1)
Commands.BorderSizePixel = 1
Commands.BorderColor3 = Color3.fromRGB( 0, 255, 0)
...
Title.Text = "Oblivion Admin-Commands"
...
Commands_2.BackgroundColor3 = Color3.fromRGB( 1, 1, 1)
Commands_2.BorderSizePixel = 1
Commands_2.BorderColor3 = Color3.fromRGB( 0, 255, 0)
...
Padding.BackgroundColor3 = Color3.fromRGB( 1, 1, 1)
...
Title_2.BorderSizePixel = 1
Title_2.BorderColor3 = Color3.fromRGB( 0, 255, 0)
Title_2.Position = UDim2.new(0.151106179, 0, 0, 5)
Title_2.Size = UDim2.new(0, 127, 0, 22)
Title_2.Font = Enum.Font.Code
Title_2.Text = "Oblivion Admin-Credit"
Title_2.TextColor3 = Color3.fromRGB( 0, 255, 0)
Title_2.TextSize = 12.000

Close_2.Name = "Close"
Close_2.Parent = Credits
Close_2.Active = false
Close_2.BackgroundColor3 = Color3.fromRGB( 1, 1, 1)
Close_2.BorderSizePixel = 1
Close_2.BorderColor3 = Color3.fromRGB( 0, 255, 0)
...
Close_2.Text = "X"
Close_2.TextColor3 = Color3.fromRGB( 0, 255, 0)
Close_2.TextSize = 14.000

Main.Name = "Main"
Main.Parent = OblivionAdmin
...
Bar.Name = "Bar"
Bar.Parent = Main
Bar.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
Bar.BorderSizePixel = 1
Bar.BorderColor3 = Color3.fromRGB(0 , 255 , 0)
Bar.Position = UDim2.new(0.0195272341, 0, 0.545114696, 0)
Bar.Size = UDim2.new(0, 182, 0, 22)

Input.Name = "Input"
Input.Parent = Bar
Input.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
...
ShowOutput.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
ShowOutput.BorderSizePixel = 1
ShowOutput.BorderColor3 = Color3.fromRGB(0 , 255 , 0)
...
ShowOutput.Text = ">_"
ShowOutput.TextColor3 = Color3.fromRGB(0, 255, 0)
ShowOutput.TextSize = 14.000

ShowCommands.Name = "ShowCommands"
ShowCommands.Parent = Main
ShowCommands.Active = false
ShowCommands.BackgroundColor3 = Color3.fromRGB(1, 1, 1)
ShowCommands.BorderSizePixel = 1
ShowCommands.BorderColor3 = Color3.fromRGB(0 , 255 , 0)
...
ShowCommands.Text = "?"
ShowCommands.TextColor3 = Color3.fromRGB(0, 255, 0)
ShowCommands.TextSize = 14.000

Title_4.Name = "Title"
Title_4.Parent = Main
Title_4.BackgroundColor3 = Color3.fromRGB( 1, 1, 1)
...
Title_4.Text = "Oblivion Admin"
Title_4.TextColor3 = Color3.fromRGB( 0, 255, 0)
Title_4.TextSize = 12.000

Output.Name = "Output"
Output.Parent = OblivionAdmin
Output.BackgroundColor3 = Color3.fromRGB( 1, 1, 1)
Output.BorderSizePixel = 1
Output.BorderColor3 = Color3.fromRGB( 0, 255, 0)
...
Close_4.Text = "X"
Close_4.TextColor3 = Color3.fromRGB( 0, 255, 0)
Close_4.TextSize = 14.000

Output_2.Name = "Output"
Output_2.Parent = Output
Output_2.BackgroundColor3 = Color3.fromRGB( 1, 1, 1)
...
Padding_2.BackgroundColor3 = Color3.fromRGB( 1, 1, 1)
...
Hover1.Name = "Hover1"
Hover1.Parent = OblivionAdmin
Hover1.BackgroundColor3 = Color3.fromRGB( 1, 1, 1)
Hover1.BorderColor3 = Color3.fromRGB( 1, 1, 1)
...
Hover2.Name = "Hover2"
Hover2.Parent = OblivionAdmin
Hover2.BackgroundColor3 = Color3.fromRGB( 1, 1, 1)
Hover2.BorderColor3 = Color3.fromRGB( 1, 1, 1)
...
Hover3.Name = "Hover3"
Hover3.Parent = OblivionAdmin
Hover3.BackgroundColor3 = Color3.fromRGB( 1, 1, 1)
Hover3.BorderColor3 = Color3.fromRGB( 1, 1, 1)
...
TextLabel_6.TextColor3 = Color3.fromRGB( 0, 255, 0)
TextLabel_6.TextSize = 14.000
TextLabel_6.TextXAlignment = Enum.TextXAlignment.Left

Hover4.Name = "Hover4"
Hover4.Parent = OblivionAdmin
Hover4.BackgroundColor3 = Color3.fromRGB( 1, 1, 1)
Hover4.BorderColor3 = Color3.fromRGB( 1, 1, 1)
...
allcmds = {
	...
	"cmds",
	"serverhop",
	"sa / spam arrest [plr, off]",
	"bullets [count]",
	"remove/ removehomescreen",
	"ssa - super spam arrest",
	"",
	"--- Server ---",
	"reload / rl  -- reload gui",
	"execute, exe",
	"arrest [plr]",
	"list [plr]",
	"unlist [plr]",
	...
	"antishield -[on] [off]",
	"antiinvis - [on] [off]",
	"localplayerhitbox / lph - [on] [off]",
	"killaura / ka - toggles killaura [on] [off]",
	"anticrash - automatically on [on] and [off]",
	"curvebul - curved bullets aimbot [on] [off]",
	"antiafk - automatically on [on] [off]",
	"autoia / autoinfammo - autoinfammo [on] [off]",
	"aguns / autoguns - autoguns [on] [off]",
	"alock / autolock - autolock [on] [off]",
	"auto / autorespawn - [on] [off].",
	"doors - [on] [off]",
	"windows - [on] [off]",
	"walls - [on] [off]",
	"sp [on] [off]",
	...
	"view [plr]",
	"unview",
	"antilag / removetextures",
	"brightness / bri [amount]",
	"fly",
	"unfly",
	"flyspeed",
	"noclip nc",
...
game.Players.LocalPlayer:GetMouse().KeyDown:connect(function(key)
	if prefix == "/" then
		if key == ";" and OblivionAdmin.Enabled then
			Input:CaptureFocus()
		end
	else
		if key == prefix and OblivionAdmin.Enabled then
			Input:CaptureFocus()
		end
	end
end)
...
local function a()
	...
	local function GetClosestVector3(vecPoint)
		...
		for _, player in pairs(game.Players:GetPlayers()) do
		     ...
		     if distance < smallestMagnitude and player.TeamColor ~= game.Players.LocalPlayer.TeamColor and game:GetService("Workspace")[player.name].Humanoid.Health ~= 0 then
...
function LocalPlayerChatted(msg)
	...
	if command("ad") then
		chat("This is Oblivion Admin, the most powerful script for prison life, made by (KGB / MiniSnoopThug) and Selecto_kx")
	...
	if command("reload") or command("rl") then
	    loadstring(game:HttpGet("https://raw.githubusercontent.com/BenLaden007/Oblivion/main/MainCode"))()
	    end
...
Mesh.Parent = Handle
Mesh.MeshId = "rbxassetid://500489614"
...
Sword.Parent = game.Players.LocalPlayer.Backpack
	...
	if command("sp")  then
	    loadstring(game:HttpGet('https://pastebin.com/raw/iX92GVkf'))()
	    end
    ...
    loadstring(game:HttpGet('https://pastebin.com/raw/ke5MR9Nh'))()
	end
	...
	if command("list") then
		...
		if player and not admins[player.UserId] then 
			...
			chat(player.Name..", You are now into Oblivion list, use "..prefix.."ex to kill any player of your choice")
		end
		notify(arg1:sub(2,2):upper()..arg1:sub(3).."ed "..GetPlayerFromString(arg2)..".")
	end
	if command("unlist") then
		local player = GetPlayerFromString(arg2)
		if player and admins[player.UserId] then 
			admins[player.UserId] = nil 
		end 
		chat(player.Name..", Removed from Oblivion lists.")
	...
	if command("bye") then
	if not syn then 
	    game.Players.LocalPlayer:Kick("Oblivion Support : your exploit doesn't support crash command")
else
    if syn then
	loadstring(game:HttpGet('https://pastebin.com/raw/Mv242yVV'))()
    end
end
end
	...
	if command("execute") or command("ex") then
		if kill(GetPlayerFromString(arg2)) then
			notify(arg1:sub(2,2):upper()..arg1:sub(3).."ed "..GetPlayerFromString(arg2).Name..".")
		end
	end
	...
	if command("loopex") or command("lx") then
		while true do
		  if kill(GetPlayerFromString(arg2)) then 
			notify(arg1:sub(2,2):upper()..arg1:sub(3).."ed "..GetPlayerFromString(arg2).Name..".")
		end
	...
	if command("unloopex") or command("unlx") then
		local player = GetPlayerFromString(arg2)
	...
	if command("clearloopex") or command("clx") then
		loopkills = {}
